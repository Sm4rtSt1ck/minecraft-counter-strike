...
#Spectral arrow
tag @a[scores={Money=200..},tag=shop_weapon,nbt=!{Inventory:[{Slot:27b,id:"minecraft:spectral_arrow",tag:{Tags:["shop"]}}]}] add buy_spectral_arrow
...
#Levitation arrow
tag @a[scores={Money=700..},tag=shop_weapon,nbt=!{Inventory:[{Slot:29b,id:"minecraft:tipped_arrow",tag:{Tags:["shop"]}}]}] add buy_levitation_arrow
...
#Different
tag @a[scores={Money=350..},tag=shop_different,nbt=!{Inventory:[{Slot:18b,id:"minecraft:lingering_potion",tag:{Tags:["shop"]}}]}] add buy_smoke_grenade
...
tag @a[scores={Money=300..},tag=shop_different,nbt=!{Inventory:[{Slot:20b,id:"minecraft:splash_potion",tag:{Tags:["shop"]}}]}] add buy_blindness
...
tag @a[scores={Money=750..},tag=shop_different,nbt=!{Inventory:[{Slot:24b,id:"minecraft:splash_potion",tag:{Tags:["shop"]}}]}] add buy_vodka
...
tag @a[scores={Money=500..},tag=shop_different,nbt=!{Inventory:[{Slot:26b,id:"minecraft:lingering_potion",tag:{Tags:["shop"]}}]}] add buy_he_grenade
...
tag @a[scores={Money=200..},tag=shop_different,nbt=!{Inventory:[{Slot:27b,id:"minecraft:lingering_potion",tag:{Tags:["shop"]}}]}] add buy_pukalka
...
tag @a[scores={Money=2250..},tag=shop_magic,nbt=!{Inventory:[{Slot:20b,id:"minecraft:ender_pearl",tag:{Tags:["shop"]}}]}] add buy_ender_pearl
...
tag @a[scores={Money=1510..},tag=shop_magic,nbt=!{Inventory:[{Slot:24b,id:"minecraft:chorus_fruit",tag:{Tags:["shop"]}}]}] add buy_chorus_fruit
...
tag @a[scores={Money=3000..},tag=shop_magic,nbt=!{Inventory:[{Slot:27b,id:"minecraft:golden_apple",tag:{Tags:["shop"]}}]}] add buy_golden_apple
...
clear @a[nbt=!{Inventory:[{Slot:24b,id:"minecraft:potion"}]}] minecraft:potion{Tags:["shop"]}
clear @a[tag=!shop_defense] minecraft:potion{Tags:["shop"]}
...
item replace entity @a[tag=shop_defense] container.24 with minecraft:potion{CustomPotionEffects:[{Id:10,Duration:400}],CustomPotionColor:16716828,display:{Name:'{"text":"Regeneration 20s","italic":false}',Lore:['{"text":"1000$","italic":false}']},Tags:["shop"]}
...
give @a[tag=buy_regeneration_potion] potion{CustomPotionEffects:[{Id:10,Duration:400}],CustomPotionColor:16716828,display:{Name:'{"text":"Potion of regeneration 10s","italic":false}'}}
...
schedule function cs_map1:loot/shop 1t
