playsound minecraft:block.end_gateway.spawn ambient @a -157 3 -136 10 1
playsound minecraft:entity.firework_rocket.twinkle_far ambient @a -157 3 -136 10 1
playsound minecraft:entity.firework_rocket.large_blast_far ambient @a -157 3 -136 10 1
particle minecraft:explosion_emitter -157 3 -136 3 3 3 0 100 force
