...
#Sorts players
function cs_map2:teams/sort

#Teleports all players to random rooms
function cs_map2:game/warmup/start

#Starts warm-up timer
schedule function cs_map2:game/warmup/preend 1000t
schedule function cs_map2:game/warmup/preend1 1140t
schedule function cs_map2:game/warmup/preend2 1160t
schedule function cs_map2:game/warmup/preend3 1180t
schedule function cs_map2:game/start 1200t
