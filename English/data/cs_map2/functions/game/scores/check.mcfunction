...
execute if score Counter-Terrorists win_status matches 1 run function cs_map2:game/rounds/round_end_ct
execute if score Terrorists win_status matches 1 run function cs_map2:game/rounds/round_end_t

#Reruns this function
execute if score Counter-Terrorists win_status matches 0 if score Terrorists win_status matches 0 run schedule function cs_map2:game/scores/check 1t
