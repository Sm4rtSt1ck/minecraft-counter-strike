...
#Spectral arrow
tag @a[scores={Money=200..,buy.arrow.sp=..2},tag=shop_weapon,nbt=!{Inventory:[{Slot:27b,id:"minecraft:spectral_arrow",tag:{Tags:["shop"]}}]}] add buy_spectral_arrow
...
#Levitation arrow
tag @a[scores={Money=700..,buy.arrow.lv=..2},tag=shop_weapon,nbt=!{Inventory:[{Slot:29b,id:"minecraft:tipped_arrow",tag:{Tags:["shop"]}}]}] add buy_levitation_arrow
...
#Different
tag @a[scores={Money=350..,buy.grenade.sm=..0},tag=shop_different,nbt=!{Inventory:[{Slot:18b,id:"minecraft:lingering_potion",tag:{Tags:["shop"]}}]}] add buy_smoke_grenade
...
tag @a[scores={Money=300..,buy.grenade.bl=..1},tag=shop_different,nbt=!{Inventory:[{Slot:20b,id:"minecraft:splash_potion",tag:{Tags:["shop"]}}]}] add buy_blindness
...
tag @a[scores={Money=750..,buy.grenade.vd=..0},tag=shop_different,nbt=!{Inventory:[{Slot:24b,id:"minecraft:splash_potion",tag:{Tags:["shop"]}}]}] add buy_vodka
...
tag @a[scores={Money=500..,buy.grenade.he=..0},tag=shop_different,nbt=!{Inventory:[{Slot:26b,id:"minecraft:lingering_potion",tag:{Tags:["shop"]}}]}] add buy_he_grenade
...
tag @a[scores={Money=200..,buy.grenade.pu=..1},tag=shop_different,nbt=!{Inventory:[{Slot:27b,id:"minecraft:lingering_potion",tag:{Tags:["shop"]}}]}] add buy_pukalka
...
tag @a[scores={Money=2000..,buy.potion.in=..0},tag=shop_different,nbt=!{Inventory:[{Slot:29b,id:"minecraft:potion",tag:{Tags:["shop"]}}]}] add buy_invisible
...
tag @a[scores={Money=2250..,buy.magic.ep=..0},tag=shop_magic,nbt=!{Inventory:[{Slot:20b,id:"minecraft:ender_pearl",tag:{Tags:["shop"]}}]}] add buy_ender_pearl
...
tag @a[scores={Money=1510..,buy.magic.cf=..2},tag=shop_magic,nbt=!{Inventory:[{Slot:24b,id:"minecraft:chorus_fruit",tag:{Tags:["shop"]}}]}] add buy_chorus_fruit
...
tag @a[scores={Money=3000..,buy.magic.ga=..0},tag=shop_magic,nbt=!{Inventory:[{Slot:27b,id:"minecraft:golden_apple",tag:{Tags:["shop"]}}]}] add buy_golden_apple
...
schedule function general1:items/shop 1t
