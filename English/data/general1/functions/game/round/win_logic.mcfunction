...
execute if score Counter-Terrorists win_status matches 1 run function general1:game/round/win_ct
execute if score Terrorists win_status matches 1 run function general1:game/round/win_t

#Reruns this function
execute if score Counter-Terrorists win_status matches 0 if score Terrorists win_status matches 0 run schedule function general1:game/round/win_logic 1t
