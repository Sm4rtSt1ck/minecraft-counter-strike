...
execute if entity @a[team=ct,x=83,y=157,z=21,dx=0.5,dy=0.5,dz=0.5,nbt={SelectedItem:{id:"minecraft:shears"}}] run fill -157 2 -135 -157 2 -137 minecraft:lime_concrete
execute if entity @a[team=ct,x=83,y=157,z=21,dx=0.5,dy=0.5,dz=0.5,nbt={SelectedItem:{id:"minecraft:shears"}}] run fill -158 2 -136 -156 2 -136 minecraft:lime_concrete
