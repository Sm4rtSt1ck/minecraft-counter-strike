playsound minecraft:block.end_gateway.spawn ambient @a 83 157 21 10 1
playsound minecraft:entity.firework_rocket.twinkle_far ambient @a 83 157 21 10 1
playsound minecraft:entity.firework_rocket.large_blast_far ambient @a 83 157 21 10 1
particle minecraft:explosion_emitter 83 157 21 3 3 3 0 100 force
