...
execute at @e[type=minecraft:armor_stand,tag=he] unless entity @e[distance=..2,type=potion,nbt={Item:{id:"minecraft:lingering_potion",Count:1b,tag:{Tags:["he"]}}}] run schedule function airplane:loot/set_air 1t
...
schedule function airplane:loot/tick 1t
